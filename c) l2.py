...
model.add(Dense(600, activation='sigmoid', kernel_regularizer=regularizers.l2(0.01)))
model.add(Dense(500, activation='sigmoid', kernel_regularizer=regularizers.l2(0.01)))
